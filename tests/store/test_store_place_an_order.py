...
def test_successful_order_placement(
    store: Store, generate_order_id, generate_id, ship_date, status, complete, order_cleanup
):
...
def test_incorrect_order_id(store: Store, incorrect_order_id, generate_id, ship_date):
    pet_id = generate_id()
...
def test_incorrect_quantity(
    store: Store, generate_order_id, generate_id, ship_date, incorrect_quantity
):
    order_id = generate_order_id()
    pet_id = generate_id()
...
def test_ship_date(
    store: Store, generate_order_id, generate_id, incorrect_ship_date
):
    order_id = generate_order_id()
    pet_id = generate_id()
...
def test_incorrect_status(
    store: Store, generate_order_id, generate_id, ship_date, incorrect_status
):
    order_id = generate_order_id()
    pet_id = generate_id()
...
def test_incorrect_complete_value(
    store: Store, generate_order_id, generate_id, ship_date, incorrect_complete_value
):
    order_id = generate_order_id()
    pet_id = generate_id()
